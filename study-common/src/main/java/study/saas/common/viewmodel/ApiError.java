...
public class ApiError extends ApiResult {
     ...
     * 密码错误
     */
    public static int NoTenantId = -423;
    ...
    public ApiError(BaseException baseException) {
        super(baseException.getHttpCode().value(), baseException.getMessage());
    }
     ...
     * @return ApiError
     */
    public static ApiError tenantIdNotFound() {
        return new ApiError(NoTenantId, "不存在的商户");
    }
